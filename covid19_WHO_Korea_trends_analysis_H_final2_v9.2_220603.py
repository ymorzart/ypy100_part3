...
#조건문 구성 @변수 입력 
duration = "Date_reported >= '2022-05-01' and Date_reported <= '@latest_date'"               
...
#plt style -> 다양한 색감의 스타일 
#plot style: ggplot, bmh, Solarize_Light2, cassic, dark_background, fast
#            fiverthirtyeight, grayscale, seaborn, seaborn-bright, etc...
plt_style = 'ggplot'
